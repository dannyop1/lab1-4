...
export default function News() {
  return (
    <div className="news-container">
      ...
      <div className="news-card">
        <img src="https://www.vietvisiontravel.com/wp-content/uploads/2017/09/Top-Best-Cinemas-in-Ho-Chi-Minh-City.jpg" alt="News 1" className="news-image" />
        <h2 className="news-title">SHAZAM POWER COMBO: CƠN THỊNH NỘ CỦA CÁC VỊ THẦN</h2>
        <p className="news-date">March 1, 2023</p>
        <p className="news-description">- Combo Shazam Power hiện đang được bán tại các rạp Cinema trên toàn quốc (Trừ Đà Nẵng, Hội An, Phan Thiết, Vinh, Nam Định, Hải Phòng, Việt Trì, Hạ Long).</p>
      </div>
      <div className="news-card">
        <img src="https://www.vietvisiontravel.com/wp-content/uploads/2017/09/Top-Best-Cinemas-in-Ho-Chi-Minh-City.jpg" alt="News 1" className="news-image" />
        <h2 className="news-title">COMBO CỰC CHẤT TIẾP THEO ĐẾN TỪ MARVEL: ANTMAN & WASP</h2>
        <p className="news-date">March 1, 2023</p>
        <p className="news-description">NỐI TIẾP SỰ THÀNH CÔNG CỦA COMBO ANT-MAN QUANTUMANIA, LOTTE CINEMA ĐÃ CHO RA MẮT NGAY COMBO TIẾP THEO MANG TÊN: ANT-MAN & WASP

- Chỉ với 170k bạn có ngay: 1 ly ANT-MAN + 1 bắp ngọt + 1 nước ngọt tùy chọn.

-  Với 200k bạn sẽ có: 1 hộp ANT-MAN + 1 bắp ngọt + 1 nước ngọt tùy chọn</p>
      </div>
      <div className="news-card">
...
Thời gian áp dụng: Cả Tuần (T2 - Chủ Nhật)</p>
      ...
      <div className="news-card">
        <img src="https://www.shutterstock.com/image-vector/cinema-movie-time-concept-theater-600w-746969203.jpg" alt="News 1" className="news-image" />
        <h2 className="news-title">GẬP TRÀN YÊU THƯƠNG CÙNG COMBO PONY VALENTINE MỚI</h2>
        <p className="news-date">March 1, 2023</p>
        <p className="news-description">VALENTINE TỚI RỒI CÙNG CHÌM ĐẮM TRONG SỰ NGỌT NGÀO VÀ ĐÁNG YÊU TRONG COMBO MỚI PONY-VALENTINE

- Chỉ với 200k bạn sẽ nhận ngay: 1 Bình Pony + 1 bắp ngọt lớn + 1 nước ngọt lớn tùy chọn

- Và 220k bạn sẽ nhận ngay: 1 Pony Box + 1 bắp ngọt lớn + 1 nước ngọt lớn tùy chọn</p>
      </div>
